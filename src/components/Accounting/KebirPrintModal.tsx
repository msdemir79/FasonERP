              ...
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div>
                  ...
                  <p className="text-[11px] text-slate-600">
                    <span className="font-semibold text-slate-800">Vergi Dairesi:</span> İkitelli V.D. &bull; <span className="font-semibold text-slate-800">VKN:</span> 7320491820 &bull; <span className="font-semibold text-slate-800">Mersis:</span> 073204918200001
                  </p>
                </div>
