        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-xs font-mono font-semibold border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-indigo-500 bg-white uppercase"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full text-xs font-bold text-blue-700 border border-gray-300 rounded-lg p-2 pr-8 focus:ring-2 focus:ring-indigo-500 bg-white"
              />
