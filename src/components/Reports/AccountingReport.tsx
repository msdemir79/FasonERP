        ...
        <div className="flex items-center bg-slate-100 p-1 rounded-xl">
          <button
            ...
            className={cn(
              ...
              activeTab === 'mizan' ? "bg-white text-indigo-700 shadow-xs" : "text-slate-600 hover:text-slate-900"
            )}
          >
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-lg transition-all cursor-pointer",
              activeTab === 'kdv' ? "bg-white text-indigo-700 shadow-xs" : "text-slate-600 hover:text-slate-900"
            )}
          >
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredAccounts.length === 0 ? (
                  ...
                  filteredAccounts.map(acc => {
                    ...
                    return (
                      <tr key={acc.id} className={cn("hover:bg-slate-50/80 transition-colors", isMain && "bg-slate-50/40 font-bold")}>
      ...
      {activeTab === 'kdv' && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6">
          ...
          <div className={cn(
            ...
            <span className="text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full bg-white/80 shadow-xs">
