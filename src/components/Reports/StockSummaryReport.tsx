  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Stok Özet Raporu</h2>
          <p className="text-slate-500 text-sm">Genel stok durumunu ve miktar özetlerini görüntüleyin.</p>
        </div>
              ...
              {filteredProducts.map((p) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <span className={cn(
                      "font-bold font-mono",
                      p.stock <= p.minStock ? "text-rose-600" : "text-slate-900"
                    )}>
                      {p.stock}
                    </span>
                  </td>
